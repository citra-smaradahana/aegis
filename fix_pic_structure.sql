-- =====================================================
-- FIX PIC STRUCTURE - USE NAME INSTEAD OF ID
-- =====================================================
-- Jalankan file ini di Supabase SQL Editor

-- 1. Update PTO table structure - Change pic_tindak_lanjut_id to VARCHAR
ALTER TABLE planned_task_observation 
ALTER COLUMN pic_tindak_lanjut_id TYPE VARCHAR(255);

-- 2. Update existing data to use names instead of IDs
...
-- 3. Update trigger function to not auto-fill pic_tindak_lanjut_id
...
BEGIN
    ...
    -- Note: pic_tindak_lanjut_id now stores name directly, not ID
    -- nrp_pic will be filled from the name when needed
...
AND column_name IN ('pic_tindak_lanjut_id', 'nrp_pic')
