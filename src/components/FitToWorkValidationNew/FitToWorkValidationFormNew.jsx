      ...
      >
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <select
            ...
            onChange={e => handleInputChange('validasi_tahap1', e.target.value)}
            style={{
              width: '100%',
              padding: '10px',
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <textarea
            ...
            onChange={e => handleInputChange('catatan_tahap1', e.target.value)}
            style={{
              width: '100%',
              padding: '10px',
              border: '1px solid #ddd',
      ...
      >
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <textarea
            ...
            onChange={e => handleInputChange('catatan_tahap2', e.target.value)}
            style={{
              width: '100%',
              padding: '10px',
              border: '1px solid #ddd',
