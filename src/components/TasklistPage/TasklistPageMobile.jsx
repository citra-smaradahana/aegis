  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      if (activeTab === "todo") {
        ...
        hazardReports = (hazardData || []).filter(isPelapor).slice(0, 50); // max 50 riwayat pelaporan
      }
                  ...
                  >
                    ...
                    <div style={{ fontSize: 15, color: "#374151" }}>
                      <div>
                        ...
                        {selectedTask.rawReport.lokasi || "-"}
                      </div>
                      <div style={{ marginTop: 4 }}>
                        <strong>Detail Lokasi:</strong>{" "}
                        {selectedTask.rawReport.detail_lokasi || "-"}
                      </div>
                      <div style={{ marginTop: 4 }}>
                        <strong>Keterangan Lokasi:</strong>{" "}
                        {selectedTask.rawReport.keterangan_lokasi || "-"}
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  >
                    ...
                    <div style={{ fontSize: 15, color: "#374151" }}>
                      <div>
                        ...
                        {selectedTask.rawReport.ketidaksesuaian || "-"}
                      </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          {hasAlasanOpen &&
                            ["Reject at Open", "Reject at Done"].includes(
                              status,
                            ) && (
                              <div>
                                <span
                                  style={{ fontWeight: 500, color: "#64748b" }}
                                >
                                  Alasan Penolakan (Open):{" "}
                                </span>
                                <span style={{ whiteSpace: "pre-wrap" }}>
                                  {r.alasan_penolakan_open}
                                </span>
                              </div>
                            )}
                          {hasAlasanDone &&
                            ["Reject at Done", "Done", "Closed"].includes(
                              status,
                            ) && (
                              <div>
                                <span
                                  style={{ fontWeight: 500, color: "#64748b" }}
                                >
                                  Alasan Penolakan (Done):{" "}
                                </span>
                                <span style={{ whiteSpace: "pre-wrap" }}>
                                  {r.alasan_penolakan_done}
                                </span>
                              </div>
                            )}
                          {hasEvaluator &&
