...
RETURNS TABLE (user_id UUID, nama TEXT, jabatan TEXT, nrp TEXT, hari_masuk INT,
  ...
  tidak_ada_masalah_pribadi BOOLEAN, siap_bekerja BOOLEAN, created_at TIMESTAMPTZ) AS $$
BEGIN
  RETURN QUERY
  SELECT v.user_id, v.nama, v.jabatan, v.nrp, v.hari_masuk::INT, v.sleep_today, v.sleep_48h,
    v.tidak_mengkonsumsi_obat, v.tidak_ada_masalah_pribadi, v.siap_bekerja, v.ftw_created_at
